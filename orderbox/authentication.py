...
class mainApiAuthentication(authentication.BaseAuthentication):
    def authenticate(self, request):
        ...
        try:
            ...
            raise exceptions.AuthenticationFailed('Нету такого пользователя') # raise exception if user does not exist 
